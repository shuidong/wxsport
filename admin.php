...
// $mysqli->select_db($dbNm);
$query = "SELECT A.avatar as avatar, A.name as name, B.checkinTime as checkinTime FROM $dbUserTbl as A, $dbChkinTbl as B WHERE A.id = B.userId order by B.checkinTime desc";
...
<!--
  ...
  <table border="1" cellspacing="0" >
  	<tr><td>头像</td><td>昵称</td><td>签到时间</td></tr>
...
while ($row = $result->fetch_assoc()) {
	...
	echo "<tr><td>" . $imgSrc . "</td><td>" . $row['name'] . "</td><td>" . $row['checkinTime'] . "</td></tr>";
